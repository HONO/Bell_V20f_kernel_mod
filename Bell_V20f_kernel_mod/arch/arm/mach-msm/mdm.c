...
/* Begin : soojin.chae@lge.com  Test code for P930 eMR RC1 */
#define DETECT_MDM_RESET_BEFORE_BOOTUP
/* End : soojin.chae@lge.com  Test code for P930 eMR RC1 */
				...
				unsigned long arg)
{
	...
	case WAKE_CHARM:
		...
		power_on_charm();
		/* Begin : soojin.chae@lge.com Test code for P930 eMR RC1 */
		#ifdef DETECT_MDM_RESET_BEFORE_BOOTUP
		charm_ready = 1;
		printk("%s : Charm_ready = %d\n",__func__, charm_ready);
		#endif
		/* End : soojin.chae@lge.com Test code for P930 eMR RC1 */
...
static irqreturn_t charm_status_change(int irq, void *dev_id)
{
	/* Begin : soojin.chae@lge.com Test code for P930 eMR RC1 */
	#ifdef DETECT_MDM_RESET_BEFORE_BOOTUP
	printk("%s : MDM2AP_STATUS = %d , Charm_ready = %d\n",__func__, gpio_get_value(MDM2AP_STATUS), charm_ready);
	#endif
	/* End : soojin.chae@lge.com Test code for P930 eMR RC1 */
