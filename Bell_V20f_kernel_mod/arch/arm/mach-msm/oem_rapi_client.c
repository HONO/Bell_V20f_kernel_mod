...
#elif defined (CONFIG_MACH_LGE_I_BOARD_SKT) || defined (CONFIG_MACH_LGE_I_BOARD_ATNT) || defined (CONFIG_MACH_LGE_I_BOARD_DCM) || defined (CONFIG_MACH_LGE_I_BOARD_BELL) || defined (CONFIG_MACH_LGE_I_BOARD_TLS)
