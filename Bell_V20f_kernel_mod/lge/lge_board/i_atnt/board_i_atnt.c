...
static struct pm8xxx_keypad_platform_data i_atnt_keypad_data = {
...
// P2BT kwanseok.kim 20120206 - I_ICS_ATT Bring up [END]
	...
	pm8058_platform_data.keypad_pdata = &i_atnt_keypad_data;
#endif
...
static void __init msm8x60_i_atnt_init_early(void)
{
...
MACHINE_START(LGE_I_BOARD, "LGE I BOARD MSM8X60")
	...
	.timer = &msm_timer,
	.init_early = msm8x60_i_atnt_init_early,
MACHINE_END
