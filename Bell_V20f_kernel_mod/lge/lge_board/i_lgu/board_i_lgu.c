...
static struct rpm_regulator_init_data rpm_regulator_init_data[] = {
...
#if 0 //defined (CONFIG_LGE_HDK_TOUCH_POWER_EN)
	...
	RPM_LDO(PM8901_L2,  0, 1, 0, 2850000, 3300000, LDO300HMIN), /* +3V0_LCD_VCC */
	RPM_LDO(PM8901_L3,  0, 1, 0, 2850000, 3300000, LDO300HMIN), /* +3V0_LCD_VCI */
...
static const unsigned int i_lgu_keymap[] = {
...
static struct matrix_keymap_data i_lgu_keymap_data = {
	.keymap_size	= ARRAY_SIZE(i_lgu_keymap),
	.keymap		= i_lgu_keymap,
};

static struct pm8xxx_keypad_platform_data i_lgu_keypad_data = {
	.input_name		= "i_lgu-keypad",
	.input_phys_device	= "i_lgu-keypad/input0",
	.num_rows		= 6,
	.num_cols		= 5,
...
static void __init msm8x60_init(struct msm_board_data *board_data)
{
   ...
   lge_add_btpower_devices();
	...
	msm8x60_init_pm8058_othc();
			...
			pm8058_platform_data.keypad_pdata = &i_lgu_keypad_data;
#endif
