...
{
	/* CAUTION: */
/*[2012.02.24][wonhee.choi@lge.com][S] add to LGE Board name for Bell model.*/
		...
		"rev_e", "rev_f", "rev_g", "rev_10", "rev_10", "rev_11", "rev_12",
			"revserved"};
/*[2012.02.24][wonhee.choi@lge.com][E] add to LGE Board name for Bell model.*/
#else /* CONFIG_MACH_LGE_I_BOARD_ATNT */
	char *rev_str[] = {"evb1", "evb2", "rev_a", "rev_b", "rev_c", "rev_d",
...
#endif
/*[2012.02.24][wonhee.choi@lge.com][S] add to LGE Board name for Bell model.*/
#ifdef CONFIG_MACH_LGE_I_BOARD_BELL
  lge_bd_target = LGE_I_BOARD_BELL;
#endif
/*[2012.02.24][wonhee.choi@lge.com][E] add to LGE Board name for Bell model.*/
/*[2012.02.28][hyojong.lim@lge.com][S] add to LGE Board name for Telus model.*/
#ifdef CONFIG_MACH_LGE_I_BOARD_TLS
  lge_bd_target = LGE_I_BOARD_TLS;
#endif
/*[2012.02.28][hyojong.lim@lge.com][E] add to LGE Board name for Telus model.*/
