...
#if 0 /* moved following macros into devices_j_tls.h */
...
static const unsigned int j_tls_keymap[] = {
	KEY(0, 0, KEY_VOLUMEUP),
	KEY(0, 1, KEY_VOLUMEDOWN),
};

static struct matrix_keymap_data j_tls_keymap_data = {
	.keymap_size	= ARRAY_SIZE(j_tls_keymap),
	.keymap		= j_tls_keymap,
};

static struct pm8xxx_keypad_platform_data j_tls_keypad_data = {
	.input_name		= "j_tls-keypad",
	.input_phys_device	= "j_tls-keypad/input0",
	.num_rows		= 6,
	.num_cols		= 5,
...
static struct msm_board_data msm8x60_lge_i_board_data __initdata = {
	.gpiomux_cfgs = msm8x60_j_tls_gpiomux_cfgs,
};
...
// P2BT kwanseok.kim 20120206 - I_ICS_ATT Bring up [END]
	...
	pm8058_platform_data.keypad_pdata = &j_tls_keypad_data;
#endif
...
static void __init msm8x60_j_tls_init(void)
{
	msm8x60_init(&msm8x60_lge_i_board_data);
}

static void __init msm8x60_j_tls_init_early(void)
{
...
MACHINE_START(LGE_I_BOARD, "LGE I BOARD MSM8X60")
	...
	.init_machine = msm8x60_j_tls_init,
	.timer = &msm_timer,
	.init_early = msm8x60_j_tls_init_early,
MACHINE_END
