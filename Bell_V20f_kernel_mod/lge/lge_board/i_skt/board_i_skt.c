...
int synaptics_t1320_power_on(int on)
{
	...
	rc = regulator_set_voltage(vreg_t1320, 2850000, 2850000);			// 20120109, lee.sangchul@lge.com
...
static struct touch_power_module touch_pwr = {
	.use_regulator	= 0,
	.vdd			= "8058_l19",
	.vdd_voltage	= 2850000,		// 20120109, lee.sangchul@lge.com
	.vio			= "8901_lvs2",
	.vio_voltage	= 1800000,
...
static struct msm_charger_platform_data msm_charger_data = {
	.safety_time = 480, // change battery charging safety time(360->480), lee.snagchul@lge.com, 2011-0818
	.update_time = 1,
	.max_voltage = 4350,
	.min_voltage = 3500,
};
...
static struct rpm_regulator_init_data rpm_regulator_init_data[] = {
	...
	RPM_LDO(PM8058_L1,  0, 1, 0, 1200000, 1200000, LDO300HMIN), /* +1V2_8MCAM_DVDD */ // jisun.shin@lge.com
	RPM_LDO(PM8058_L2,  0, 1, 0, 0, 0, LDO300HMIN), /* GND */			// 2012-0110, lee.sangchul@lge.com
	RPM_LDO(PM8058_L3,  0, 1, 0, 3300000, 3300000, LDO150HMIN), /* +3V3_MHL */
	RPM_LDO(PM8058_L4,  0, 1, 0, 2850000, 2850000,  LDO50HMIN), /* +2V85_PM_TCXO */
	RPM_LDO(PM8058_L5,  0, 1, 0, 2850000, 2850000, LDO300HMIN), /* +2V85_MSM_P2 */		// 2012-0131, lee.sangchul@lge.com
#ifdef CONFIG_USB_G_LGE_ANDROID_FACTORY
	...
	RPM_LDO(PM8058_L8,  0, 1, 0, 2800000, 2800000, LDO300HMIN), /* +2V8_8MCAM_AF */ // jisun.shin@lge.com
	RPM_LDO(PM8058_L9,  0, 1, 0, 2800000, 2800000, LDO300HMIN), /* +2V8_8MCAM_AVDD */ //jisun.shin@lge.com
	RPM_LDO(PM8058_L10, 0, 1, 0, 0, 0, LDO300HMIN), /* NC */                   // 2012-0110, lee.sangchul@lge.com
	...
	RPM_LDO(PM8058_L14, 0, 0, 0, 2850000, 2850000, LDO300HMIN), /* +2V85_MICRO_SD */	                   // 2012-0110, lee.sangchul@lge.com
	...
	RPM_LDO(PM8058_L17, 0, 1, 0, 0, 0, LDO150HMIN), /* GND */			// 2012-0201, lee.sangchul@lge.com
	RPM_LDO(PM8058_L18, 0, 1, 1, 2200000, 2200000, LDO150HMIN), /* +2V2_XOADC_REF */
	RPM_LDO(PM8058_L19, 0, 1, 0, 2850000, 2850000, LDO150HMIN), /* +2V85_TOUCH */	// 2012-0131, lee.sangchul@lge.com
	...
	RPM_VS(PM8058_LVS0, 0, 1, 0), /* +1.8V_CAM_VDDIO */ //jisun.shin@lge.com
	RPM_VS(PM8058_LVS1, 0, 1, 0), /* +1V8_MSM_QFUSE */

	RPM_NCP(PM8058_NCP, 0, 1, 0, 0, 0), /* NC */                   // 2012-0110, lee.sangchul@lge.com
	RPM_LDO(PM8901_L0,  0, 1, 0, 0, 0, LDO300HMIN), /* NC */
	RPM_LDO(PM8901_L1,  0, 1, 0, 0, 0, LDO300HMIN), /* NC */ //sungwoo.cho@lge.com                   // 2012-0110, lee.sangchul@lge.com
...
//20110826 - edward.park@lge.com : Pattern Unlcok [END]
};
...
static struct othc_regulator_config othc_reg = {
	.regulator	 = "8058_l5",
/* [LGE_CHANGE_S] 2012-0118, lee.sangchul@lge.com */
	.max_uV		 = 2850000,
	.min_uV		 = 2850000,
/* [LGE_CHANGE_E] 2012-0118, lee.sangchul@lge.com */
};
...
#if 0	//def CONFIG_LGE_PMIC8058_REGULATOR //platform@lge.com : for SD-card VDD margin, 2012-0201, lee.sangchul@lge.com
