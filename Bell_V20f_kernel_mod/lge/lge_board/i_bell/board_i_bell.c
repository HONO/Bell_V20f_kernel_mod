...
#if 0 /* moved following macros into devices_i_bell.h */
...
// P2BT kwanseok.kim 20120206 - I_ICS_ATT Bring up [START]
...
// P2BT kwanseok.kim 20120206 - I_ICS_ATT Bring up [END]
...
static const unsigned int i_bell_keymap[] = {
	KEY(0, 0, KEY_VOLUMEUP),
	KEY(0, 1, KEY_VOLUMEDOWN),
};

static struct matrix_keymap_data i_bell_keymap_data = {
	.keymap_size	= ARRAY_SIZE(i_bell_keymap),
	.keymap		= i_bell_keymap,
};

static struct pm8xxx_keypad_platform_data i_bell_keypad_data = {
	.input_name		= "i_bell-keypad",
	.input_phys_device	= "i_bell-keypad/input0",
	.num_rows		= 6,
	.num_cols		= 5,
	...
	.row_hold_ns            = 91500,
	.wakeup			= 1,
	.keymap_data		= &i_bell_keymap_data,
};
...
static struct msm_board_data msm8x60_lge_i_board_data __initdata = {
	.gpiomux_cfgs = msm8x60_i_bell_gpiomux_cfgs,
};
...
// P2BT kwanseok.kim 20120206 - I_ICS_ATT Bring up [END]
	...
	pm8058_platform_data.keypad_pdata = &i_bell_keypad_data;
#endif
...
static void __init msm8x60_i_bell_init(void)
{
	msm8x60_init(&msm8x60_lge_i_board_data);
}

static void __init msm8x60_i_bell_init_early(void)
{
...
MACHINE_START(LGE_I_BOARD, "LGE I BOARD MSM8X60")
	...
	.init_machine = msm8x60_i_bell_init,
	.timer = &msm_timer,
	.init_early = msm8x60_i_bell_init_early,
MACHINE_END
