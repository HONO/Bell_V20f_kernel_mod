...
//[2012.03.05][wonhee.choi@lge.com][S] add to bell feature refer by AT&T feature.	
#elif defined(CONFIG_MACH_LGE_I_BOARD_BELL)
	if (lge_bd_rev < LGE_REV_C) {
		pr_info("Test....................................................pcb rev.B\n");
		ret = pm_chg_batt_temp_disable(1);
	} else {
...
#elif defined(CONFIG_MACH_LGE_I_BOARD_TLS)
	if (lge_bd_rev < LGE_REV_C) {
		pr_info("Test....................................................pcb rev.B\n");
		ret = pm_chg_batt_temp_disable(1);
	} else {
...
#endif
int batt_read_adc(int channel, int *mv_reading)
{
	int ret;
	void *h;
...
EXPORT_SYMBOL(pm8058_is_battery_present);
...
#ifdef CONFIG_LGE_CHARGER_TEMP_SCENARIO
int pm8058_get_battery_temperature_adc(void)
{
	int mv_reading;
...
EXPORT_SYMBOL(pm8058_get_battery_temperature_adc);
#endif
...
EXPORT_SYMBOL(pm8058_is_battery_temp_within_range);
...
EXPORT_SYMBOL(pm8058_is_battery_id_valid);
...
#endif
	pr_info("%s: vbatt_mv is %d(qcom:%d)\n", __func__, vbatt_mv, batt_read_adc(CHANNEL_ADC_VBATT, NULL));
	if (vbatt_mv > 0)
		return vbatt_mv;
	/*
...
EXPORT_SYMBOL(pm8058_get_battery_mvolts);
